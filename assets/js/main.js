! function() {
  ...
  const r = new class {
    ...
    watch(e, n = !0) {
      if ("function" != typeof e) throw new Error("Value passed to Watch is not a function");
      if (!t) {
        if (n) {
          const t = this.formatData();
          t.scroll.changed = !0, t.mouse.changed = !0, t.size.changed = !0, t.position.changed = !0, t.orientation.changed = !0, t.devicePixelRatio.changed = !0, e(t)
        }
        this.callbacks.push(e)
      }
    }
    unwatch(e) {
      if ("function" != typeof e) throw new Error("The value passed to unwatch is not a function");
  ...
  const i = r.watch,
    ...
    a = t => "/" == t ? t : t.replace(/\/$/g, ""),
    s = t => {
      if ("string" != typeof t || !t) throw new Error("Value passed must be a string");
      let e;
      e = "/" == t.substr(0, 1) ? t : "?" == t.substr(0, 1) ? `${window.location.pathname.replace(/\/$/,"")}/${t}` : "#" == t.substr(0, 1) ? window.location.pathname + window.location.search + t : `${window.location.pathname.replace(/\/$/,"")}/${t}`;
      let [n, r] = e.split("#"), [i, o] = n.split("?");
      const s = o ? o.split("&").reduce((t, e) => {
        const [n, r] = e.split("=");
        return {
          ...t,
          [n]: r
  ...
  var u = new class {
    constructor(t) {
      ...
      this._updatePosition(r, i, o), this._updatePathData(r, e.initPathData), window.addEventListener("popstate", this._handlePop)
    }
    _updatePosition(t, e, n) {
      if (this._prevURL = this._currentURL, this._currentURL = {
          path: a(t),
          hash: e,
          params: n
        ...
        if (this._didHashChange() && this._didParamsChange()) return "HASHPARAMS";
        if (!this._didHashChange() && !this._didParamsChange()) return "NOCHANGE"
      }
    }
    _updatePathData(t, e) {
      const n = a(t);
    ...
    _mergeRegisteredData(t) {
      return {
        ...this._registeredPaths.reduce((e, n) => n.regex.test(t) ? {
          ...e,
          ...n.data
        } : e, {}),
        ...this._pathData[t]
    ...
    push(t, e) {
      ...
      o = o || "PUSH", history.pushState(null, null, t), this._callbacks.forEach(t => t({
    ...
    _handlePop(t) {
      ...
      let o = this._updatePosition(n, r, i);
      o = o || "POP", this._callbacks.forEach(t => t({
        ...this.getCurrentState(),
        action: o
      }))
    }
    ...
    _didParamsChange() {
      return this._currentURL.path == this._prevURL.path && (t = this._currentURL.params, e = this._prevURL.params, !(Object.keys(t).every(n => n in e && t[n] === e[n]) && Object.keys(e).every(n => n in t && t[n] === e[n])));
      var t, e
    }
    getCurrentState() {
      return {
    ...
    registerPath(t, e) {
      return this._registeredPaths = [...this._registeredPaths, {
        path: t,
        regex: c(t),
        data: e
    ...
    g(document.querySelectorAll(".reveal-img")).forEach((function(t) {
      new IntersectionObserver((function(e, n) {
        e.forEach((function(e) {
          e.intersectionRatio > 0 && (! function(t) {
            var e = t.querySelector("img");
            t.classList.add("is-ready"), e.onload = function() {
              return function(t) {
                t.classList.add("is-active"), t.classList.remove("is-ready")
              }(t)
            }, setTimeout((function() {
              e.setAttribute("src", t.dataset.src)
            }), 500)
          }(t), n.unobserve(e.target))
        }))
      }), {
        rootMargin: "-100px",
        threshold: .35
  ...
  var b = "loading--in",
    x = new(function() {
      function t() {
        l(this, t), this.openLoader = this.openLoader.bind(this), this.closeLoader = this.closeLoader.bind(this), this.openTimeout, this.closeTimeout, this.loaderEl = document.querySelector(".loading"), this.loaderEl && (this.loaderMask = this.loaderEl.querySelector(".loading__mask"), document.querySelector("html").classList.add("is-loading"))
      }
      return d(t, [{
        key: "openLoader",
        value: function(t) {
          this.loaderMask && (this.loaderEl.classList.remove("loading--out"), this.loaderEl.classList.add(b), document.querySelector("html").classList.remove("is-loading"), clearTimeout(this.openTimeout), clearTimeout(this.closeTimeout), this.openTimeout = setTimeout((function() {
            "function" == typeof t && t()
          }), 500))
        }
      }, {
        ...
        value: function(t) {
          var e = this;
          this.loaderMask && this.loaderEl.classList.contains(b) && (this.loaderEl.classList.remove(b), this.loaderEl.classList.add("loading--out"), document.querySelector("html").classList.remove("is-loading"), clearTimeout(this.openTimeout), clearTimeout(this.closeTimeout), this.closeTimeout = setTimeout((function() {
            "function" == typeof t && t(), e.loaderEl.classList.remove("loading--out"), e.loaderEl.classList.remove(b)
          }), 500))
        }
      }]), t
    }()),
    ...
    _ = function() {
      ...
      if (t) {
        ...
        t.innerHTML = O[["skirrid", "sugarloaf", "blorenge"][Math.floor(3 * Math.random())]]
      }
    },
    C = function(t, e) {
  ...
  var Y = function() {
    ...
    q = /^(#[0-9a-f]{3}|#(?:[0-9a-f]{2}){2,4}|(rgb|hsl)a?\((-?\d+%?[,\s]+){2,3}\s*[\d\.]+%?\))$/i,
    V = {
      test: function(t) {
    ...
    N = function(t) {
      return function(e) {
        ...
        for (var n, r = {}, i = (n = e, n.substring(n.indexOf("(") + 1, n.lastIndexOf(")"))).split(/,\s*/), o = 0; o < 4; o++) r[t[o]] = void 0 !== i[o] ? parseFloat(i[o]) : 1;
        return r
      }
    },
    Z = Y(Y({}, V), {
  ...
  var J, Q = {
    ...
    nt = {
      ...
      parse: function(t) {
        return Q.test(t) ? Q.parse(t) : tt.test(t) ? tt.parse(t) : et.test(t) ? et.parse(t) : t
      },
      transform: function(t) {
    ...
    it = {
      ...
      createTransformer: function(t) {
        ...
        return function(t) {
          for (var r = e, o = 0; o < n; o++) r = r.replace(o < i ? "${c}" : "${n}", o < i ? nt.transform(t[o]) : E(t[o]));
          return r
        }
      },
    ...
    ot = 0,
    at = "undefined" != typeof window && void 0 !== window.requestAnimationFrame ? function(t) {
      return window.requestAnimationFrame(t)
    } : function(t) {
      var e = Date.now(),
        n = Math.max(0, 16.7 - (e - ot));
      ot = e + n, setTimeout((function() {
        return t(ot)
      }), n)
    };
  ! function(t) {
  ...
  var st, ct = 1 / 60 * 1e3,
      ...
      var n = function(t) {
        var e = [],
          ...
          c = {
            ...
            process: function(u) {
              var l, h;
              if (i = !0, e = (l = [n, e])[0], (n = l[1]).length = 0, r = e.length)
                for (o = 0; o < r; o++)(h = e[o])(u), !0 !== s.has(h) || a.has(h) || (c.schedule(h), t(!0));
              i = !1
            },
            schedule: function(t, o, c) {
              ...
              var u = c && i,
                l = u ? e : n;
              a.delete(t), o && s.add(t), -1 === l.indexOf(t) && (l.push(t), u && (r = e.length))
            }
          };
        return c
      }(pt);
      return t.sync[e] = function(t, e, r) {
        return void 0 === e && (e = !1), void 0 === r && (r = !1), lt || xt(), n.schedule(t, e, r), t
    ...
    bt = function(t) {
      lt = !1, dt.delta = ut ? ct : Math.max(Math.min(t - dt.timestamp, 40), 1), ut || (ct = dt.delta), dt.timestamp = t, ht = !0, ft.forEach(wt), ht = !1, lt && (ut = !1, at(bt))
    },
    xt = function() {
      lt = !0, ut = !0, ht || at(bt)
    },
    ...
    Ct = (st = function(t, e, n) {
      return Math.min(Math.max(n, t), e)
    }, function(t, e, n) {
      return void 0 !== n ? st(t, e, n) : function(n) {
        return st(t, e, n)
      }
    }),
    At = function(t, e, n) {
  ...
  var qt = function(t, e) {
    var n = t.slice(),
      ...
      i = t.map((function(t, n) {
        return r = t, i = e[n], "number" == typeof r ? function(t) {
          return At(r, i, t)
        } : nt.test(r) ? Et(r, i) : jt(r, i);
        var r, i
      }));
    return function(t) {
  ...
  function Vt(t) {
    for (var e = it.parse(t), n = e.length, r = 0, i = 0, o = 0, a = 0; a < n; a++) r || "number" == typeof e[a] ? r++ : void 0 !== e[a].hue ? o++ : i++;
    return {
      parsed: e,
      numNumbers: r,
      numRGB: i,
  ...
  var Tt, jt = function(t, e) {
    ...
    Wt = (Ct(0, 1), function(t) {
      ...
      return function(t) {
        ...
        function u(t, e) {
          ...
          var n = o[t];
          o[t] = e, o[t] !== n && (-1 === s.indexOf(t) && s.push(t), c || (c = !0, vt.render(l.render)))
        }
        var l = {
          get: function(t, n) {
          ...
          render: function(t) {
            return void 0 === t && (t = !1), (c || !0 === t) && (n(o, r, s), c = !1, s.length = 0), this
          }
        };
        return l
      }
    ...
    Nt = ["", "X", "Y", "Z"],
    Zt = ["translate", "scale", "rotate", "skew", "transformPerspective"].reduce((function(t, e) {
  ...
  function le(t, e, n, r, i, o, a, s) {
    ...
    for (var h in t) {
      var d = t[h],
        f = ie(h),
        p = oe(d, f);
      Jt(h) ? (u = !0, r[h] = p, o.push(h), c && (f.default && d !== f.default || !f.default && 0 !== d) && (c = !1)) : ee(h) ? (i[h] = p, l = !0) : se.has(h) && ue(p) || (n[It(h, a)] = p)
    }
    return (u || "function" == typeof t.transform) && (n.transform = function(t, e, n, r, i, o) {
      void 0 === o && (o = !0);
      var a = "",
        s = !1;
      n.sort(Qt);
      ...
      return !s && i ? a += "translateZ(0)" : a = a.trim(), ue(t.transform) ? a = t.transform(e, r ? "" : a) : o && r && (a = "none"), a
    }(t, r, o, c, e, s)), l && (n.transformOrigin = (i.originX || "50%") + " " + (i.originY || "50%") + " " + (i.originZ || 0)), n
  }
  ...
  var de = Wt({
    ...
    onRender: function(t, e, n) {
      ...
      if (Object.assign(r.style, i(t)), o)
        ...
        } - 1 !== n.indexOf("scrollLeft") && (r.scrollLeft = t.scrollLeft), -1 !== n.indexOf("scrollTop") && (r.scrollTop = t.scrollTop)
    },
    uncachedValues: ae
  });
  var fe = new Set(["baseFrequency", "diffuseConstant", "kernelMatrix", "kernelUnitLength", "keySplines", "keyTimes", "limitingConeAngle", "markerHeight", "markerWidth", "numOctaves", "targetX", "targetY", "surfaceScale", "specularConstant", "specularExponent", "stdDeviation", "tableValues"]),
    pe = function(t, e) {
  ...
  function ye(t, e, n, r, i, o) {
    void 0 === e && (e = me), void 0 === r && (r = he(ve)), void 0 === i && (i = {
      style: {}
    }), void 0 === o && (o = !0);
    var a = t.attrX,
      s = t.attrY,
      ...
      f = t.pathOffset,
      p = void 0 === f ? 0 : f,
      m = r(L(t, ["attrX", "attrY", "originX", "originY", "pathLength", "pathSpacing", "pathOffset"]));
    for (var g in m) {
      if ("transform" === g) i.style.transform = m[g];
      else i[o && !fe.has(g) ? Ht(g) : g] = m[g]
    }
    return (void 0 !== c || void 0 !== u || m.transform) && (i.style.transformOrigin = function(t, e, n) {
      return ge(e, t.x, t.width) + " " + ge(n, t.y, t.height)
    }(e, void 0 !== c ? c : .5, void 0 !== u ? u : .5)), void 0 !== a && (i.x = a), void 0 !== s && (i.y = s), void 0 !== n && void 0 !== l && (i[o ? "stroke-dashoffset" : "strokeDashoffset"] = pe(-p, n), i[o ? "stroke-dasharray" : "strokeDasharray"] = pe(l, n) + " " + pe(d, n)), i
  }
  ...
  var be = Wt({
    ...
    Se = function(t, e) {
      var n, r, i, o;
      return t === window ? n = xe(t) : ! function(t) {
      ...
      }(r) && r.getTotalLength ? r.getTotalLength() : void 0, n = be({
        element: r,
        buildAttrs: we(i, o)
      })) : n = function(t, e) {
        void 0 === e && (e = {});
  ...
  var _e = function() {
      ...
      return t.prototype.applyMiddleware = function(t) {
        return this.create(A(A({}, this.props), {
          middleware: this.props.middleware ? P([t], this.props.middleware) : [t]
        }))
    ...
    Ae = function(t) {
      ...
      return function(t, e) {
      ...
      }(e, t), e.prototype.create = function(t) {
        return new e(t)
        ...
        return n = i ? A(A({}, n), i) : n, t.registerParent && t.registerParent(n), e && n.stop(), n
      }, e
    }(_e),
    Le = function(t) {
      return new Ae({
      ...
      mapApi: function(t, e) {
        return function() {
          ...
          return Object.keys(t).reduce((function(r, i) {
            var o;
            return t[i][e] && (n[0] && void 0 !== n[0][i] ? r[i] = t[i][e](n[0][i]) : r[i] = (o = t[i])[e].apply(o, n)), r
          }), {})
        }
      },
      ...
      mapApi: function(t, e) {
        return function() {
          ...
          return t.map((function(t, r) {
            if (t[e]) return Array.isArray(n[0]) ? t[e](n[0][r]) : t[e].apply(t, n)
          }))
        }
      },
      setProp: function(t, e, n) {
    ...
    ze = function(t) {
      return "number" == typeof t ? qe : Array.isArray(t) ? Ve : function(t) {
        return Boolean(ke(t))
      }(t) ? je : nt.test(t) ? De : it.test(t) ? He : "object" == typeof t ? Te : qe
    },
    Ue = Be((function(t) {
      var e = t.from,
        n = void 0 === e ? 0 : e,
        ...
        a = void 0 === o ? Ot : o,
        s = t.reverseEase;
      return void 0 !== s && s && (a = St(a)), Le((function(t) {
        var e = t.update;
        return {
          seek: function(t) {
            return e(t)
    ...
    Ge = function(t) {
      return void 0 === t && (t = {}), Le((function(e) {
        var n, r = e.update,
          ...
          k = function() {
            R = !0, n = vt.update((function(t) {
              var e, r = t.delta;
              M += r, X(), !(e = R && M > a + g) || (!e || d || l || p) && (M = a - (M - g), d && L < d ? (L++, 1) : l && O < l ? (O++, E(), 1) : p && C < p && (C++, E(C % 2 != 0), 1)) || (yt.update(n), i && vt.update(i, !1, !0))
            }), !0)
          },
          q = function() {
            R = !1, n && yt.update(n)
  ...
  if ("undefined" != typeof document) {
    Fe(document, "touchstart touchmove", {
      passive: !0,
      capture: !0
    }).start((function(t) {
      var e = t.touches,
  ...
  var Je = 0,
    ...
    rn = (new(function() {
      function t() {
        var e = this;
        l(this, t), this.menuEl = document.querySelector(".js-menu"), this.triggerEl = document.querySelector(".js-menu-trigger"), this.openLabelEl = document.querySelector(".js-menu-label-open"), this.closeLabelEl = document.querySelector(".js-menu-label-close"), this.toggleMenu = this.toggleMenu.bind(this), this.menuEl && this.triggerEl.addEventListener("click", (function(t) {
      ...
      return d(t, [{
        ...
        value: function() {
          ...
          if (void 0 === t) {
            this.triggerEl.classList.toggle("is-active"), this.menuEl.classList.toggle("is-open"), document.querySelector("html").classList.toggle("lock-scroll");
            var e = this.menuEl.classList.contains("is-open");
            this.closeLabelEl.setAttribute("aria-hidden", !e), this.openLabelEl.setAttribute("aria-hidden", e), this.triggerEl.setAttribute("aria-expanded", e)
          }!0 === t && (this.triggerEl.classList.add("is-active"), this.menuEl.classList.add("is-open"), document.querySelector("html").classList.add("lock-scroll"), this.triggerEl.setAttribute("aria-expanded", !0), this.closeLabelEl.setAttribute("aria-hidden", !1), this.openLabelEl.setAttribute("aria-hidden", !0)), !1 === t && (this.triggerEl.classList.remove("is-active"), this.menuEl.classList.remove("is-open"), document.querySelector("html").classList.remove("lock-scroll"), this.triggerEl.setAttribute("aria-expanded", !1), this.closeLabelEl.setAttribute("aria-hidden", !0), this.openLabelEl.setAttribute("aria-hidden", !1))
        }
      }]), t
    }())).toggleMenu,
    on = function(t) {
      g((t || document.querySelector("body")).querySelectorAll('a[href^="/"], a[href^="#"]')).forEach((function(t) {
        t.addEventListener("click", (function(e) {
          e.preventDefault();
          var n = t.getAttribute("href");
          if (window.location.pathname == n || window.location.pathname == n + "/") return rn(!1), !1;
          u.push(n)
        }))
      }))
    },
  ...
  var sn = function(t) {
      ...
      g(document.querySelectorAll("[data-reveal]")).forEach((function(t) {
        var r = t.dataset.reveal,
          ...
          o = t.dataset.offset ? parseInt(t.dataset.offset) : t.getBoundingClientRect().top + window.pageYOffset;
        n.changed && (t.dataset.offset = Math.floor(t.getBoundingClientRect().top + window.pageYOffset)), e.changed && e.bottom > o + n.y / 4 && !i && (t.classList.add(r), delete t.dataset.reveal, delete t.dataset.offset)
      }))
    },
    cn = function(t) {
      if (t) {
        var e = document.querySelector(t);
        e ? window.scrollTo(0, e.getBoundingClientRect().top + window.scrollY) : window.scrollTo(0, 0)
    ...
    un = function(t) {
      ...
      M((function() {
        var t;
        (t = e, fetch(t).then((function(t) {
          if (!t.ok) throw new Error("Ajax page-load failed!");
          return t.text()
        }))).then((function(t) {
          if (window.location.pathname != e && window.location.pathname != e + "/") return rn(!1), !1;
          var r, a = (new DOMParser).parseFromString(t, "text/html");
          (r = a).querySelectorAll(".reveal-img").length && r.querySelectorAll(".reveal-img").forEach((function(t) {
            ...
            function(t) {
              ...
              document.querySelector("head").appendChild(t.querySelector("#theme"))
            }(a), _(), rn(!1), document.querySelector(".page-body").remove(), document.querySelector("html").classList.remove("lock-scroll"), o(sn), setTimeout((function() {
              return S((function() {
                var t = a.querySelector(".page-body"),
                  e = document.querySelector(".main-menu");
                e.parentElement.insertBefore(t, e.nextSibling), cn(n), on(t), w(),
                  function(t) {
                    g(document.querySelectorAll("script.custom-js")).forEach((function(t) {
                      t.parentNode.removeChild(t)
                    })), g(t.querySelectorAll("script.custom-js")).forEach((function(t) {
                      var e = t.getAttribute("src"),
                        n = document.createElement("script");
                      n.className = "custom-js", n.setAttribute("async", !0), n.setAttribute("src", e), document.querySelector("body").appendChild(n)
                    }))
                  }(a), i(sn)
              }))
            }), 200)
  ...
  u.watch((function(t) {
    ...
    if (n.changed) {
      ...
      a && (a.style.transform = "translate(".concat(90 * i, "%, ").concat(90 * o, "%"))
    }
    if (r.changed) {
      var s = Math.min(Math.max(r.gamma / 22.5, -1), 1),
        c = Math.min(Math.max(r.beta / 45, -1), 1),
        u = (e.x / 2 + e.x / 2 * (.66 * s)) / e.x,
        l = (e.y / 2 + e.y / 2 * (.66 * c)) / e.y,
        h = document.querySelector(".pointer");
      h && (h.style.transform = "translate(".concat(90 * u, "%, ").concat(90 * l, "%"))
    }
  })), i(sn), i((function(t) {
    var e = t.mouse,
      n = t.orientation,
    ...
    g(document.querySelectorAll("[data-drift]")).forEach((function(t) {
      var i = m(t.dataset.drift.split(" ").map((function(t) {
          return parseInt(t)
        })), 2),
        o = i[0],
        a = i[1],
        s = [];
      if (t.dataset.driftCenter && (s = t.dataset.driftCenter.split(" ").filter((function(t) {
          return "x" == t || "y" == t
        }))), e.changed) {
        var c = (e.x - r.x / 2) / (r.x / 2),
          u = (e.y - r.y / 2) / (r.y / 2);
        t.style.transform = "".concat(s.includes("x") ? "translateX(-50%)" : "").concat(s.includes("y") ? "translateY(-50%)" : "", " translate(").concat(o * c, "px, ").concat(a * u, "px)")
      }
      if (n.changed) {
        var l = Math.min(Math.max(n.gamma / 22.5, -1), 1),
          h = Math.min(Math.max(n.beta / 45, -1), 1);
        t.style.transform = "".concat(s.includes("x") ? "translateX(-50%)" : "").concat(s.includes("y") ? "translateY(-50%)" : "", " translate(").concat(o * l, "px, ").concat(a * h, "px)")
      }
    }))
  })), i((function(t) {
    var e = t.size,
      n = t.scroll;
    n.changed && g(document.querySelectorAll("[data-prlx]")).forEach((function(t) {
      var r = m(t.dataset.prlx.split(" ").map((function(t) {
          return parseFloat(t)
        })), 2),
        i = r[0],
        o = r[1];
      n.top, e.y;
      t.style.position = "relative", t.style.transform = "translate3d(".concat(n.top * i, "px, ").concat(n.top * o, "px, 0)")
    }))
  })), i((function(t) {
    var e = t.mouse,
      n = t.orientation,
    ...
    if (i) {
      var o, a = i.classList.contains("dizzy"),
      ...
      if (a && (o = {
        ...
        var O = (o.x - r.x / 2) / (r.x / 2),
          ...
          C = (o.x - r.x / 2) / (r.x / 4);
        C = (C = C < -1 ? -1 : C) > 1 ? 1 : C;
        var A, L = (o.y - r.y / 2) / (r.y / 4);
        if (L = (L = L < -1 ? -1 : L) > 1 ? 1 : L, !a)
          if (L < 0 && C < 0 && (A = 1), L < 0 && C >= 0 && (A = 2), L >= 0 && C >= 0 && (A = 3), L >= 0 && C < 0 && (A = 4), A != Qe && (Qe = A, Je += 1, setTimeout((function() {
              Je = Je <= 0 ? 0 : Je - 1
            }), 500)), Je >= 5) return function() {
            var t = document.querySelector(".avatar");
            t.classList.add("dizzy"), Je = 0, setTimeout((function() {
              t.classList.remove("dizzy")
            }), 6e3)
          }(), !1;
        l.style.transition = "all 100ms 10ms ease-out", l.style.transform = "translateX(".concat(Math.ceil(10 * O), "px)"), h.style.transition = "all 100ms 10ms ease-out", h.style.transform = "translateY(".concat(Math.ceil(10 * _) < -3 ? -3 : Math.ceil(10 * _), "px)"), s.style.transform = "translateY(".concat(L < 0 ? Math.ceil(1 * L) : Math.ceil(3 * L), "px)"), c.forEach((function(t) {
          return t.style.transform = "rotate(".concat(3 * C * L, "deg)")
        })), u.forEach((function(t) {
          return t.style.transform = L < 0 ? "translateY(".concat(Math.ceil(1 * L), "px) translateX(").concat(Math.ceil(1.25 * C), "px)") : "translateY(".concat(Math.ceil(3 * L), "px) translateX(").concat(Math.ceil(1.25 * C), "px)")
        })), v.style.transform = "translateX(".concat(C < 0 ? Math.ceil(1 * C) : Math.ceil(-1 * C), "px)"), y.style.transform = "translateX(".concat(C < 0 ? Math.ceil(-1 * C) : Math.ceil(1 * C), "px)"), d.style.transform = "translateY(".concat(C < 0 ? -5 + Math.ceil(2 * C) : -5 + Math.ceil(5 * C), "px)"), m.style.transform = "translateY(".concat(C < 0 ? -3 + Math.ceil(-5 * C) : -3 + Math.ceil(-3 * C), "px)"), w.style.transform = L < 0 ? "scaleY(".concat(1 + -1 * L * .025, ")") : "scaleY(".concat(1 - .025 * L);
        var P = en.y,
          Y = en.duration,
          R = tn.d;
        if (C < -.5 && L < -.5 || C > .5 && L < -.5 ? (P = en.y, Y = en.duration, R = en.d) : (C < -.5 && L > .5 || C > .5 && L > .5 || L > .5) && (P = nn.y, Y = nn.duration, R = nn.d), x !== R && !a) {
    ...
    if (document.querySelector(".clock")) {
      var e = new Date,
        ...
        r = e.getHours() / 12 * 360;
      document.querySelector(".clock-pivot__hand--minute").parentElement.style.transform = "rotate(".concat(n, "deg)"), document.querySelector(".clock-pivot__hand--hour").parentElement.style.transform = "rotate(".concat(r, "deg)")
    }
    requestAnimationFrame(t)
  })), on(), window.addEventListener("load", (function() {
    setTimeout((function() {
      S((function() {
        "undefined" != typeof window && console.log("%c  >>>|||<<<  ", "\n        font-family: monospace; \n        padding: 8px 10px; \n        background: #9d2d38; \n        color: #fff; \n        font-size: 18px;\n        font-weight: bold;\n      "), w()
      }))
    }), 1e3)
  }))
}();
